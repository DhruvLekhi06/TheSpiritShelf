  ...
  return (
    <nav className={`flex items-center justify-center space-x-2 ${className}`} aria-label="Pagination">
      <button
        ...
        className="px-3 py-2 sm:px-4 font-medium bg-brand-surface border border-brand-outline rounded-lg text-brand-light disabled:opacity-50 disabled:cursor-not-allowed hover:bg-brand-outline transition-colors"
      >
        Previous
      </button>
