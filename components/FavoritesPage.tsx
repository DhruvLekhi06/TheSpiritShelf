...
const FavoritesPage: React.FC = () => {
    ...
    const favoriteAlcohols = alcoholData.filter(alcohol => favorites.includes(alcohol.id));

    const totalPages = Math.ceil(favoriteAlcohols.length / ITEMS_PER_PAGE);
    const currentFavorites = useMemo(() => favoriteAlcohols.slice(
        (currentPage - 1) * ITEMS_PER_PAGE,
        currentPage * ITEMS_PER_PAGE
    ), [currentPage, favoriteAlcohols]);
    ...
    return (
        ...
        >
            <div className="text-center mb-12">
                <h1 className="text-4xl sm:text-5xl font-serif font-bold tracking-tight text-white">Your Favorites</h1>
